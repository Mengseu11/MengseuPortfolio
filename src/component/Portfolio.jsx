...
export default function Portfolio() {
  const projects = [
    {
      category: "Website",
      title: "Movie",
      link: "https://movie-istad.vercel.app/",
      externalLink: false,
      image: "",
    ...
    },
    {
      category: "Website",
      title: "Ecommerce",
      link: "https://final-project-nine-zeta-86.vercel.app/",
      externalLink: false,
      image: "",
        ...
        <CardWrapper>
          <div className="flex md:flex-row items-stretch gap-6">
            ...
            <div className="flex justify-between bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 border border-gray-700/50 hover:border-orange-400/30 transition-all duration-300 hover:shadow-lg hover:shadow-orange-400/10">
              <div>
              <span className="inline-block text-sm font-medium text-orange-400 mb-2">
                {project.category}
              </span>
  ...
  {project.externalLink ? (
    <a
      ...
      className="hidden sm:inline-block px-6 py-2 rounded-md text-white bg-orange-500 hover:bg-orange-600 transition-colors"
