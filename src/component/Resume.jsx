...
export default function Resume() {
  ...
  const education = [
    ...
    {
      institution: "Moung Ruessei High School",
      degree: "",
      period: "2020 - 2022",
      description: "2021-2022 Graduated High Shcool At Moung Ruessei High School"
    }
  ];

  const TimelineItem = ({ item, isExperience = false }) => (
    <div className="relative pl-8 pb-8 last:pb-0">
      <div className="absolute left-0 top-2 w-3 h-3 bg-gradient-to-r from-orange-400 to-yellow-500 rounded-full shadow-lg">
        <div className="absolute inset-0 bg-gradient-to-r from-orange-400 to-yellow-500 rounded-full animate-pulse opacity-50"></div>
      </div>
      ...
      <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 border border-gray-700/50 hover:border-orange-400/30 transition-all duration-300 hover:shadow-lg hover:shadow-orange-400/10">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2">
          ...
          <span className="text-sm text-orange-400 font-medium bg-orange-400/10 px-3 py-1 rounded-full mt-1 sm:mt-0">
            {item.period}
          </span>
        </div>
      ...
      <div className="max-w-6xl ">
        ...
        <div className=" mb-16">
          <h2 className="text-4xl font-bold text-white mb-4">
            My <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-yellow-500">Resume</span>
          </h2>
