...
export default function ContactForm() {
 ...
 const handleSubmit = async (e) => {
  ...
  const botToken = '7820787226:AAGiKOy87tNKR5SXlBrJt6r5cFYJAXxQEvY'; // from BotFather
  const chatId = '1825152003';     // your personal ID from getUpdates
...
`;
  ...
  <form onSubmit={handleSubmit} className="space-y-4">
    ...
    <button type="submit" className="px-6 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded">
      Send Message
    </button>
  </form>
</section>
