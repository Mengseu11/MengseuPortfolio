    ...
    <>
      ...
      <nav className="bg-[#0F0F0F] text-white px-6 py-4 fixed top-0 left-0 right-0 z-40 shadow-lg">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <h1 className="text-2xl font-bold text-orange-500">MENGSEU</h1>
            ...
            {navLinks.map((link) => (
              <li key={link.to}>
                <Link
                  ...
                  spy={true}
                  offset={-70}
                  activeClass="text-orange-500 border-b-2 border-orange-500"
                  className="cursor-pointer hover:text-orange-500 transition relative px-2 py-1"
                >
                  {link.label}
                </Link>
              </li>
